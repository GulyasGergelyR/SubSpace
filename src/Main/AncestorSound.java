...
public class AncestorSound {
    ...
    */
 	...
 	*/
        ...
        // a sound
        ambient = AudioLoader.getAudio("WAV", ResourceLoader.getResourceAsStream("res/audio/ambient.wav"));	
        aifEffect = AudioLoader.getAudio("WAV", ResourceLoader.getResourceAsStream("res/audio/single_laser_shot.wav"));
        wavEffect = AudioLoader.getAudio("WAV", ResourceLoader.getResourceAsStream("res/audio/small_blast.wav"));
        } catch (IOException e) {
        e.printStackTrace();
    }
    }
        ...
        while (Keyboard.next()) {
            if (Keyboard.getEventKeyState()) {
                if (Keyboard.getEventKey() == Keyboard.KEY_E) {
                    ...
                    // the mod
                    ambient.playAsMusic(1.0f, 0.1f, true);
                }
    ...
    public static void main(String[] argv) {
        AncestorSound soundExample = new AncestorSound();
        soundExample.start();
    }
}